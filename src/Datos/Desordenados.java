...
public class Desordenados {
    ...
    public Desordenados(int limite, int size) {
    ...
    public int[] getCopiaValores(){
     ...
     public Ordenados algoritmoSort(){
        ...
        return new Ordenados(arreglo);
    }
    
    public Ordenados bubbleSort(){
        int [] arreglo = this.getCopiaValores();
	...
	// devolver los datos ordenados
        return new Ordenados(a);
    }
    
    public Ordenados mergeSort(){
